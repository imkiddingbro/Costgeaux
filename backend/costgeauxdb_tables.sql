...
INSERT INTO product (p_name, price, p_Quantity, p_section) VALUES ('apple', '2.00', '45', 'Produce Section');
INSERT INTO product (p_name, price, p_Quantity, p_section) VALUES ( 'orange', '1.00', '40', 'Produce Section');
INSERT INTO product (p_name, price, p_Quantity, p_section) VALUES ( 'banana', '4.00', '35', 'Produce Section');
INSERT INTO product (p_name, price, p_Quantity, p_section) VALUES ( 'grape', '7.00', '50', 'Produce Section');
INSERT INTO product (p_name, price, p_Quantity, p_section) VALUES ( 'blueberry', '2.50', '30', 'Produce Section');
INSERT INTO product (p_name, price, p_Quantity, p_section) VALUES ( 'strawberry', '2.99', '45', 'Produce Section');
...
INSERT INTO employee (e_name, e_City, e_State, e_Position) VALUES ('Chris', 'Covington', 'LA', 'cashier');
INSERT INTO employee (e_name, e_City, e_State, e_Position) VALUES ('Jun', 'Houston', 'TX', 'janitor');
INSERT INTO employee (e_name, e_City, e_State, e_Position) VALUES ('Alex', 'New York City', 'NY', 'employee');

INSERT INTO customer (c_name, c_City, c_State) VALUES ('Ryan', 'Homa', 'LA');
INSERT INTO customer (c_name, c_City, c_State) VALUES ('Jessica', 'San Antonio', 'TX');
INSERT INTO customer (c_name, c_City, c_State) VALUES ('Robert', 'Lake Charles', 'LA');
INSERT INTO customer (c_name, c_City, c_State) VALUES ('Kenny', 'Austin', 'TX');
INSERT INTO customer (c_name, c_City, c_State) VALUES ('Alexis', 'Trenton', 'NJ');

INSERT INTO Supplier (s_name, s_City, s_State, s_Stock) VALUES ('FoodFactory', 'Atlanta', 'GA', '140');
INSERT INTO Supplier (s_name, s_City, s_State, s_Stock) VALUES ('Kirkland', 'Miami', 'FL', '250');
INSERT INTO Supplier (s_name, s_City, s_State, s_Stock) VALUES ('Meat Distributor', 'San Diego', 'CA', '610');
INSERT INTO Supplier (s_name, s_City, s_State, s_Stock) VALUES ('US Foods', 'Richmond', 'VA', '280');
INSERT INTO Supplier (s_name, s_City, s_State, s_Stock) VALUES ('Food Group', 'Galveston', 'TX', '790');



-- Step 1: Purchase steak for customer "Ryan"
INSERT INTO Cart (customer_id, product_id, item_count, total_price)
SELECT c.c_id, p.p_id, 2 AS item_count, 2 * p.price AS total_price
FROM Customer c, Product p
WHERE c.c_name = 'Ryan' AND p.p_name = 'steak' AND p.p_Quantity >= 2;
...
WHERE p_name = 'steak' AND p_Quantity >= 2;

SET SQL_SAFE_UPDATES = 1;

-- Step 2: Purchase strawberry for customer "Ryan"
INSERT INTO Cart (customer_id, product_id, item_count, total_price)
SELECT c.c_id, p.p_id, 3 AS item_count, 3 * p.price AS total_price
FROM Customer c, Product p
WHERE c.c_name = 'Ryan' AND p.p_name = 'strawberry' AND p.p_Quantity >= 3;
...
WHERE p_name = 'strawberry' AND p_Quantity >= 3;
...
-- Step 1: Employee purchases steak from supplier
INSERT INTO OrderStock (employee_id, supplier_id, product_id, item_count, total_price)
SELECT e.e_id, s.s_id, p.p_id, 5 AS item_count, 5 * p.price AS total_price
FROM Employee e, Supplier s, Product p
WHERE e.e_name = 'John'  -- Employee "John"
  AND s.s_name = 'FoodFactory'  -- Supplier "FoodFactory"
  AND p.p_name = 'steak'  -- Product "steak"
  AND p.p_Quantity >= 5;  -- Check if enough stock is available

SET SQL_SAFE_UPDATES = 0;

-- Step 2: Update Product quantity for steak after purchase
UPDATE Product
SET p_Quantity = p_Quantity + 5  -- Increase quantity after purchase
WHERE p_name = 'steak';
